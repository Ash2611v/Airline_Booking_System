...
//                setIcon(new ImageIcon(ClassLoader.getSystemResource("airline/management/system/icon/bg3.jpg")));
//                .setBackground(Color.WHITE);
//        Journey Details.setIcon(new ImageIcon(ClassLoader.getSystemResource("airline/management/system/icon/bg3.jpg")));
	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	
	setLayout(null);
		
	Source = new JLabel("SOURCE");
	Source.setFont(new Font("Serif", Font.BOLD, 19));
	Source.setBounds(60, 100, 150, 27);
	add(Source);
	
        Destination = new JLabel("DESTINATION");
	Destination.setFont(new Font("Serif", Font.BOLD, 19));
...
//        Show.setBackground;
	...
	Jnytime.setFont(new Font("Serif", Font.PLAIN, 13));
	Jnytime.setBounds(494, 270, 83, 20);
	add(Jnytime);
		
	Source = new JLabel("SOURCE");
	Source.setFont(new Font("Serif", Font.PLAIN, 13));
	Source.setBounds(613, 270, 94, 20);
	add(Source);
		
	Destination = new JLabel("DESTINATION");
	Destination.setFont(new Font("Serif", Font.PLAIN, 13));
